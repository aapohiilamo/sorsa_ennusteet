...
# STEP 2: Download Total Population Data
...
# Add Finland 2024 net migration and 2025 population using ISO2 = "FI", code = 246
fin_mig_2024 <- tibble(code = "246", year = 2024, migration = 47051)
fin_pop_2025 <- tibble(code = "246", year = 2025, population = 5635971)

fin_mig_2025 <- tibble(code = "246", year = 2025, migration = 28000)
...
# STEP 3: Use population from next year as denominator
...
# Add country names using countrycode
